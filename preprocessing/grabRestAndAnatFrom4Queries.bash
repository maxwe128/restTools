...
while read subScan;do
	...
	####ONLY untar data if age is over 18 and we don't already have data#################
		if [[ $scannerCheck == "mr750" ]] && [ $(echo "$scanAgeCheck > 18" | bc) -eq 1 ] && [[ $scanDateCheckSecs -gt 1310702400 ]];then # last check is because first 2 chronological rest scans were for testing and throw off script
